...
type TUserState = { 
  ...
  readonly userInfoRequest: boolean,
  readonly userInfoFailed: boolean,
  ...
  readonly profileRequest: boolean,
...
export const userReducer = (state = initialStateUser, action: TUserActions): TUserState => {
  switch (action.type) {
    //запрос логина
